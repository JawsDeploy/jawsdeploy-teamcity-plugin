...
<div class="parameter">
  <label for="jawsdeploy.apiBaseUrl">API Base URL: <l:star/></label>
...
<div class="parameter">
  <label for="secure:jawsdeploy_apiKey">API Key: <l:star/></label>
  <props:passwordProperty name="secure:jawsdeploy_apiKey" />
</div>
<div class="parameter">
...
<div class="parameter">
  <label for="jawsdeploy.notes">Release notes</label>
